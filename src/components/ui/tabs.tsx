...
function TabsList({
  ...
  return (
    <TabsPrimitive.List
      data-slot="tabs-list"
      className={cn(
        "ss-pattern-control bg-muted text-muted-foreground inline-flex h-9 w-fit items-center justify-center p-[3px] flex",
        className,
      )}
      {...props}
    />
